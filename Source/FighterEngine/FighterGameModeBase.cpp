...
void AFighterGameModeBase::RegisterExistingPlayers()
{
...
void AFighterGameModeBase::PostLogin(APlayerController* NewPlayer)
{
...
void AFighterGameModeBase::PreLogout(APlayerController* InPlayerController)
{
